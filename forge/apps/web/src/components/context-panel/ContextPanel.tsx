...
import { readFile, fetchLocalGitStatus, type LocalGitStatus } from "@/lib/api-client";

/**
 * Não existe hoje um endpoint HTTP do Context Hub (ver ARCHITECTURE.md) —
 * este painel lê LUNA_CONTEXT.md diretamente via capability de filesystem
 * (working directory local) e monta a visão sem inventar um resumo por IA.
 * Missão atual é o início real do arquivo, não uma reescrita.
 */
