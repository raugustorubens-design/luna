...
export const sendMessage = async (sendMessageRequest: SendMessageRequest, options?: RequestInit): Promise<ChatMessage> => {
...
export const getMessages = async (id: string, options?: RequestInit): Promise<ChatMessage[]> => {
 ...
 */
export const getGetGatewayCapabilitiesUrl = () => {
...
export const getGatewayCapabilities = async ( options?: RequestInit): Promise<GetGatewayCapabilities200> => {

  return customFetch<GetGatewayCapabilities200>(getGetGatewayCapabilitiesUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetGatewayCapabilitiesQueryKey = () => {
    return [
...
export const getGetGatewayCapabilitiesQueryOptions = <TData = Awaited<ReturnType<typeof getGatewayCapabilities>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getGatewayCapabilities>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetGatewayCapabilitiesQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getGatewayCapabilities>>> = ({ signal }) => getGatewayCapabilities({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getGatewayCapabilities>>, TError, TData> & { queryKey: QueryKey }
}

export type GetGatewayCapabilitiesQueryResult = NonNullable<Awaited<ReturnType<typeof getGatewayCapabilities>>>
export type GetGatewayCapabilitiesQueryError = ErrorType<unknown>
...
export function useGetGatewayCapabilities<TData = Awaited<ReturnType<typeof getGatewayCapabilities>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getGatewayCapabilities>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetGatewayCapabilitiesQueryOptions(options)
 ...
 */
export const getExecuteGatewayCapabilityUrl = () => {




  return `/api/gateway/execute`
}

export const executeGatewayCapability = async (capabilityRequest: CapabilityRequest, options?: RequestInit): Promise<CapabilityResult> => {

  return customFetch<CapabilityResult>(getExecuteGatewayCapabilityUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getExecuteGatewayCapabilityMutationOptions = <TError = ErrorType<CapabilityResult>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof executeGatewayCapability>>, TError,{data: BodyType<CapabilityRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof executeGatewayCapability>>, TError,{data: BodyType<CapabilityRequest>}, TContext> => {

const mutationKey = ['executeGatewayCapability'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof executeGatewayCapability>>, {data: BodyType<CapabilityRequest>}> = (props) => {
          const {data} = props ?? {};

          return  executeGatewayCapability(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ExecuteGatewayCapabilityMutationResult = NonNullable<Awaited<ReturnType<typeof executeGatewayCapability>>>
    export type ExecuteGatewayCapabilityMutationBody = BodyType<CapabilityRequest>
    export type ExecuteGatewayCapabilityMutationError = ErrorType<CapabilityResult>

    /**
 * @summary Execute a gateway capability through the registry
 */
export const useExecuteGatewayCapability = <TError = ErrorType<CapabilityResult>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof executeGatewayCapability>>, TError,{data: BodyType<CapabilityRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof executeGatewayCapability>>,
        TError,
        {data: BodyType<CapabilityRequest>},
        TContext
      > => {
      return useMutation(getExecuteGatewayCapabilityMutationOptions(options));
    }
